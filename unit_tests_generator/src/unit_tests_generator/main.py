...
from unit_tests_generator.crews.git_clone_crew.git_clone_crew import GitCloneCrew
from unit_tests_generator.crews.generate_unit_test_crew.generate_unit_test_crew import GenerateUnitTestCrew
from unit_tests_generator.crews.git_checkout_and_commit_crew.git_checkout_and_commit_crew import GitCheckoutAndCommitCrew
...
class UnitTestGeneratorFlow(Flow[State]):
    ...
    @listen(generate_unit_test_for_the_given_class)
